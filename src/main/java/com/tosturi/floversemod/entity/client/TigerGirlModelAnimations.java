...
public class TigerGirlModelAnimations {
    ...
    public static final AnimationDefinition WALK = AnimationDefinition.Builder.withLength(3.0F).looping()
        .addAnimation("Left Hand", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(1.5F, KeyframeAnimations.degreeVec(-25.0F, 0.0F, -2.0F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(3.0F, KeyframeAnimations.degreeVec(20.0F, 0.0F, -2.0F), AnimationChannel.Interpolations.CATMULLROM)
        ))
        ...
        .addAnimation("Right Hand", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(1.5F, KeyframeAnimations.degreeVec(20.0F, 0.0F, 2.0F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(3.0F, KeyframeAnimations.degreeVec(-20.0F, 0.0F, 2.0F), AnimationChannel.Interpolations.CATMULLROM)
        ))
        ...
        .addAnimation("Tail_1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            ...
            new Keyframe(1.5F, KeyframeAnimations.degreeVec(4.0F, -10.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(3.0F, KeyframeAnimations.degreeVec(4.0F, 10.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
        ))
        .addAnimation("Tail_2", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(-25.1891F, 6.7938F, -3.1846F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(1.5F, KeyframeAnimations.degreeVec(-25.1891F, -6.7938F, 3.1846F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(3.0F, KeyframeAnimations.degreeVec(-25.1891F, 6.7938F, -3.1846F), AnimationChannel.Interpolations.CATMULLROM)
        ))
        .addAnimation("Tail_3", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(-15.0547F, -4.8293F, 1.2971F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(1.5F, KeyframeAnimations.degreeVec(-15.0547F, 4.8293F, -1.2971F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(3.0F, KeyframeAnimations.degreeVec(-15.0547F, -4.8293F, 1.2971F), AnimationChannel.Interpolations.CATMULLROM)
        ))
        .addAnimation("Tail_4", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(-7.5641F, 7.4355F, -0.9844F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(1.5F, KeyframeAnimations.degreeVec(-7.5641F, -7.4355F, 0.9844F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(3.0F, KeyframeAnimations.degreeVec(-7.5641F, 7.4355F, -0.9844F), AnimationChannel.Interpolations.CATMULLROM)
        ))
        .addAnimation("Tail_5", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(21.2809F, 6.8122F, -4.3151F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(1.5F, KeyframeAnimations.degreeVec(21.2809F, -6.8122F, 4.3151F), AnimationChannel.Interpolations.CATMULLROM),
            new Keyframe(3.0F, KeyframeAnimations.degreeVec(21.2809F, 6.8122F, -4.3151F), AnimationChannel.Interpolations.CATMULLROM)
        ))
        .build();
